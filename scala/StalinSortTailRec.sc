...
stalinSort(List(3, 2, 1))        // val res1: List[Int] = List(3)
stalinSort(List(1, 1, 1))        // val res2: List[Int] = List(1)
stalinSort(List(3))              // val res3: List[Int] = List(3)
stalinSort(List())               // val res4: List[Int] = List()
stalinSort(List(1, 5, 2, 7, 1))  // val res5: List[Int] = List(1, 5, 7)
